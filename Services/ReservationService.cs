...
namespace Hotel_Management.Services
{
    public class ReservationService
    {
        ...
        public ReservationService(IMapper mapper, GeneralRepository<Reservation> generalRepository,GeneralRepository<Room> roomrepository)
        {
            _ReservationRepository = generalRepository;
        ...
        {
            return await _ReservationRepository.GetOneWithTrackingAsync(e => e.Id == Id);
        }
